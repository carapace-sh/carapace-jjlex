...
2. verify with `cmd/carapace-jjlex` and see if the change broke sth. else
3. if so, use the same session to tell it what broke (this can take 2-3 iterations) 
4. tell it to add tests
