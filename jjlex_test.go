...
func TestSplit(t *testing.T) {
	for revset, expected := range map[string]CompletionContext{
		...
		"rev | r":                 {Prefix: "r", Type: CompletionTypeRevision, AttachedRevset: "r"},
		"rev | r-":                {Prefix: "r-", Type: CompletionTypeRevision, AttachedRevset: "r-"},
		"parents(":                {Type: CompletionTypeFunctionArg, FunctionName: "parents", ExpectingRevset: true},
		"parents(a":               {Prefix: "a", Type: CompletionTypeFunctionArg, FunctionName: "parents", ArgumentIndex: 0, AttachedRevset: "a", ExpectingRevset: true},
		"parents(1":               {Prefix: "1", Type: CompletionTypeFunctionArg, FunctionName: "parents", ArgumentIndex: 0, AttachedRevset: "1", ExpectingRevset: true},
		"parents(1a":              {Prefix: "1a", Type: CompletionTypeFunctionArg, FunctionName: "parents", ArgumentIndex: 0, AttachedRevset: "1a", ExpectingRevset: true},
		"parents(1a/":             {Prefix: "1a/", Type: CompletionTypeFunctionArg, FunctionName: "parents", ArgumentIndex: 0, AttachedRevset: "1a/", ExpectingRevset: true},
		"parents(1a/b":            {Prefix: "1a/b", Type: CompletionTypeFunctionArg, FunctionName: "parents", ArgumentIndex: 0, AttachedRevset: "1a/b", ExpectingRevset: true},
		"parents(v1":              {Prefix: "v1", Type: CompletionTypeFunctionArg, FunctionName: "parents", ArgumentIndex: 0, AttachedRevset: "v1", ExpectingRevset: true},
		"parents(v1.":             {Prefix: "v1.", Type: CompletionTypeFunctionArg, FunctionName: "parents", ArgumentIndex: 0, AttachedRevset: "v1.", ExpectingRevset: true},
		"parents(v1.0.0":          {Prefix: "v1.0.0", Type: CompletionTypeFunctionArg, FunctionName: "parents", ArgumentIndex: 0, AttachedRevset: "v1.0.0", ExpectingRevset: true},
		"parents(v1.0.0-beta":     {Prefix: "v1.0.0-beta", Type: CompletionTypeFunctionArg, FunctionName: "parents", ArgumentIndex: 0, AttachedRevset: "v1.0.0-beta", ExpectingRevset: true},
		...
		"parents(a) |":            {Prefix: "", Type: CompletionTypeRevision},
		"parents(a) | ":           {Prefix: "", Type: CompletionTypeRevision},
		"parents(a,":              {Prefix: "", Type: CompletionTypeFunctionArg, FunctionName: "parents", ArgumentIndex: 1, ExpectingRevset: false},
		"parents(a,1":             {Prefix: "1", Type: CompletionTypeFunctionArg, FunctionName: "parents", ArgumentIndex: 1, AttachedRevset: "", ExpectingRevset: false},
		"parents(a, 2":            {Prefix: "2", Type: CompletionTypeFunctionArg, FunctionName: "parents", ArgumentIndex: 1, AttachedRevset: "", ExpectingRevset: false},
		"parents(children(a":      {Prefix: "a", Type: CompletionTypeFunctionArg, FunctionName: "children", ArgumentIndex: 0, AttachedRevset: "a", ExpectingRevset: true},
		"parents(children(a,3":    {Prefix: "3", Type: CompletionTypeFunctionArg, FunctionName: "children", ArgumentIndex: 1, AttachedRevset: "", ExpectingRevset: false},
